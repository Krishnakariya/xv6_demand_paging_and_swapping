...
main(int argc, char *argv[])
{
  ...
  11:	e8 0c 03 00 00       	call   322 <bstat>
 ...
 349:	85 d2                	test   %edx,%edx
{
 ...
 377:	f7 f1                	div    %ecx
 379:	0f b6 92 58 07 00 00 	movzbl 0x758(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 594:	e9 8f fe ff ff       	jmp    428 <printf+0x48>
          s = "(null)";
 599:	bb 4f 07 00 00       	mov    $0x74f,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 fc 09 00 00       	mov    0x9fc,%eax
{
 ...
 5ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ef:	a3 fc 09 00 00       	mov    %eax,0x9fc
}
 5f4:	5b                   	pop    %ebx
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 fc 09 00 00       	mov    %eax,0x9fc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 fc 09 00 00    	mov    0x9fc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6e7:	89 15 fc 09 00 00    	mov    %edx,0x9fc
}
 ...
 6f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 fc 09 00 00 00 	movl   $0xa00,0x9fc
 707:	0a 00 00 
 70a:	c7 05 00 0a 00 00 00 	movl   $0xa00,0xa00
 711:	0a 00 00 
    base.s.size = 0;
 714:	b8 00 0a 00 00       	mov    $0xa00,%eax
 719:	c7 05 04 0a 00 00 00 	movl   $0x0,0xa04
 720:	00 00 00 
